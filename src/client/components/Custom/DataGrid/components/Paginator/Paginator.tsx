...
const Paginator = ({
  ...
  return (
    <div className={`${style.foot} ${className || ""}`}>
      {totalPages > 1 ? (
        <div className={style.row}>
          <div className={style.cell}>
            <span>{t("common.paginator.page")}</span>
            <input
              name="grid-foot-row-cell-paginator-input"
              id="grid-foot-row-cell-paginator-input"
            ...
            <div className={style.buttonsContainer}>
              <button
                ...
                type="button"
                id="grid-foot-row-cell-button-prevButton"
              >
                <svg
                  width="9"
                  height="17"
              ...
              <button
                ...
                id="grid-foot-row-cell-button-nextButton"
              >
                <svg
                  width="9"
                  height="17"
