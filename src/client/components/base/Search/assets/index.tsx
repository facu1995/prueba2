const Assets = {
  lupe: (
    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path
        d="M21 21.75C20.81 21.75 20.62 21.68 20.47 21.53L18.47 19.53C18.18 19.24 18.18 18.76 18.47 18.47C18.76 18.18 19.24 18.18 19.53 18.47L21.53 20.47C21.82 20.76 21.82 21.24 21.53 21.53C21.38 21.68 21.19 21.75 21 21.75Z"
        fill="#737373"
      />
    </svg>
  )
