import productFilter from "./productFilter.svg"
import subCategorys from "./subCategory.svg"
...
const svg = {
  ...
  customers,
  collections,
  "catalogs-products-filter": productFilter,
  "catalogs-products-filter-category": category,
  "catalogs-products-filter-subcategory": subCategorys
}
